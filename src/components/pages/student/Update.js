    ...
    return (
        <div className='student-update'>
            <form action="" className="form-group">
                <h2 className='form-heading bg-warning text-white text-center'>UPDATING STUDENT</h2>
                <div className="form-body">
                    <div className="form-body__left">
                        ...
                        <div className="gender-dropdown dropdown d-flex">
                            ...
                            <button className="btn btn-warning dropdown-toggle" type="button" id="gender_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Gender
                            </button>
                    ...
                    <div className="form-body__right">
                        ...
                        <div className="major-dropdown dropdown d-flex">
                            ...
                            <button className="btn btn-warning dropdown-toggle" type="button" id="major_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Major
                            </button>
                        ...
                        <div className="campus-dropdown dropdown d-flex">
                            ...
                            <button className="btn btn-warning dropdown-toggle" type="button" id="campus_dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Campus
                            </button>
